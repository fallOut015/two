...
public class MagmeelModel<T extends Entity> extends EntityModel<T> {
	...
	public MagmeelModel(int length) {
		...
		for(int i = 0; i < length; ++ i) {
			this.segmentModels[i] = new MagmeelSegmentModel(this, i * -16);
		}
		this.tailModel = new MagmeelTailModel(this, -160);
	}
	...
	public class MagmeelHeadModel extends Model {
		...
		public MagmeelHeadModel(Model base) {
			...
			lowerJaw = new ModelRenderer(base);
			...
			upperJaw = new ModelRenderer(base);
	...
	public class MagmeelSegmentModel extends Model {
		...
		public MagmeelSegmentModel(Model base, float distance) {
			super(RenderType::getEntityCutout);
			...
			segment.setTextureOffset(0, 0).addBox(-2.0F, -4.0F, -16.0F + distance, 4.0F, 4.0F, 16.0F, 0.0F, false);
			segment.setTextureOffset(0, 0).addBox(0.0F, -8.0F, -6.0F + distance, 0.0F, 8.0F, 6.0F, 0.0F, false);
			segment.setTextureOffset(0, 0).addBox(0.0F, -8.0F, -14.0F + distance, 0.0F, 8.0F, 6.0F, 0.0F, false);
		}
	...
	public class MagmeelTailModel extends Model {
		...
		public MagmeelTailModel(Model base, float distance) {
			super(RenderType::getEntityCutout);
			
			textureWidth = 32;
			textureHeight = 16;

			tail = new ModelRenderer(base);
			tail.setRotationPoint(0.0F, 24.0F, -8.0F);
			tail.setTextureOffset(0, 2).addBox(-1.0F, -1.0F, 0.0F + distance, 2.0F, 1.0F, 8.0F, 0.0F, false);
			tail.setTextureOffset(0, 0).addBox(0.0F, -4.0F, 2.0F + distance, 0.0F, 4.0F, 4.0F, 0.0F, false);
		}
