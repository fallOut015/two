...
public class MapleTapBlock extends Block {
	...
	protected static final VoxelShape MAPLE_TAP_EAST_AABB = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 3.0D, 16.0D, 16.0D);
	protected static final VoxelShape MAPLE_TAP_WEST_AABB = Block.makeCuboidShape(13.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	protected static final VoxelShape MAPLE_TAP_SOUTH_AABB = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 3.0D);
	protected static final VoxelShape MAPLE_TAP_NORTH_AABB = Block.makeCuboidShape(0.0D, 0.0D, 13.0D, 16.0D, 16.0D, 16.0D);
	...
	private boolean canAttachTo(IBlockReader blockReader, BlockPos blockPos, Direction direction) {
		...
		return blockstate.getBlock() == BlocksTwo.MAPLE_LOG;
