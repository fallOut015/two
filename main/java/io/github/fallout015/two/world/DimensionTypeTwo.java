...
public class DimensionTypeTwo extends DimensionType {
	...
	public static final RegistryKey<DimensionType> NIGHTMARE_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, NIGHTMARE_LOCATION);
	public static final RegistryKey<DimensionType> SKY_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, SKY_LOCATION);
	public static final RegistryKey<DimensionType> FROSTBITE_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, FROSTBITE_LOCATION);
	public static final RegistryKey<DimensionType> NIDAVELLIR_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, NIDAVELLIR_LOCATION);
	public static final RegistryKey<DimensionType> DEEP_DARK_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, DEEP_DARK_LOCATION);
	public static final RegistryKey<DimensionType> BLOOD_AETHER_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, BLOOD_AETHER_LOCATION);
	public static final RegistryKey<DimensionType> RAINBOW_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, RAINBOW_LOCATION);
	public static final RegistryKey<DimensionType> UMBRAL_PLANE_KEY = RegistryKey.getOrCreateKey(Registry.DIMENSION_TYPE_KEY, UMBRAL_PLANE_LOCATION);
