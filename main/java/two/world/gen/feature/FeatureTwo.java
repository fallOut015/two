...
//	OreFeatureConfig.FillerBlockType PACKED_ICE = OreFeatureConfig.FillerBlockType.create("packed_ice", "", BlockMatcher.forBlock(Blocks.PACKED_ICE));
	...
	public static final TreeFeatureConfig GHOSTWOOD = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(GHOSTWOOD_LOG), new SimpleBlockStateProvider(GHOSTWOOD_LEAVES), new BlobFoliagePlacer(2, 0))).baseHeight(5).heightRandA(2).heightRandB(3).ignoreVines().setSapling((IPlantable) BlocksTwo.GHOSTWOOD_SAPLING).build();
	public static final TreeFeatureConfig CLOUDWOOD = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(CLOUDWOOD_LOG), new SimpleBlockStateProvider(CLOUDWOOD_LEAVES), new BlobFoliagePlacer(2, 0))).baseHeight(5).heightRandA(2).heightRandB(3).ignoreVines().setSapling((IPlantable) BlocksTwo.CLOUDWOOD_SAPLING).build();
