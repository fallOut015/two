...
public class EffectsTwo {
	public static final Effect FROSTY = register("frosty", (new EffectTwo(EffectType.HARMFUL, 14024703)).addAttributesModifier(SharedMonsterAttributes.MOVEMENT_SPEED, "e81d73be-7ee5-4811-b94b-d9eb3fb4c9cb", -1d, AttributeModifier.Operation.MULTIPLY_TOTAL));
