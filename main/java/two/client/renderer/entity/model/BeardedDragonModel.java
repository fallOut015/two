...
public class BeardedDragonModel<T extends BeardedDragonEntity> extends EntityModel<T> {
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		this.legBottomLeft.rotateAngleY = MathHelper.cos(limbSwing * 3.6662F) * 1.4F * limbSwingAmount - 0.7853981633974483F;
		this.legTopRight.rotateAngleY = MathHelper.cos(limbSwing * 3.6662F + (float)Math.PI) * 1.4F * limbSwingAmount - 0.7853981633974483F;
		this.legBottomRight.rotateAngleY = MathHelper.cos(limbSwing * 3.6662F) * 1.4F * limbSwingAmount + 0.7853981633974483F;
		this.legTopLeft.rotateAngleY = MathHelper.cos(limbSwing * 3.6662F + (float)Math.PI) * 1.4F * limbSwingAmount + 0.7853981633974483F;
