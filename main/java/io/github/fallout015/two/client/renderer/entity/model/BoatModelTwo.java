...
@OnlyIn(Dist.CLIENT)
public class BoatModelTwo extends SegmentedModel<BoatEntityTwo> {
	...
	public void setRotationAngles(BoatEntityTwo entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	protected void func_228244_a_(BoatEntityTwo p_228244_1_, int p_228244_2_, float p_228244_3_) {
