...
public class WallTorchBlockTwo extends TorchBlockTwo {
	...
	public WallTorchBlockTwo(AbstractBlock.Properties properties, Supplier<IParticleData> particleData) {
	...
	public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
		...
		worldIn.addParticle(this.particleData.getValue(), d0 + 0.27D * (double)direction1.getXOffset(), d1 + 0.22D, d2 + 0.27D * (double)direction1.getZOffset(), 0.0D, 0.0D, 0.0D);
	}
