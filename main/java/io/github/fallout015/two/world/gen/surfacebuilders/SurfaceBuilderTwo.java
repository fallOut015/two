...
public class SurfaceBuilderTwo {
	...
	public static final SurfaceBuilder<SurfaceBuilderConfig> NIGHTMARE = register("nightmare", new NightmareSurfaceBuilder(SurfaceBuilderConfig.field_237203_a_));
	public static final SurfaceBuilder<SurfaceBuilderConfig> NIGHTMARE_HIGHLANDS = register("nightmare_highlands", new NightmareHighlandsSurfaceBuilder(SurfaceBuilderConfig.field_237203_a_));
	public static final SurfaceBuilder<SurfaceBuilderConfig> SKY = register("sky", new SkySurfaceBuilder(SurfaceBuilderConfig.field_237203_a_));
	public static final SurfaceBuilder<SurfaceBuilderConfig> FROSTBITE = register("frostbite", new FrostbiteSurfaceBuilder(SurfaceBuilderConfig.field_237203_a_));
	public static final SurfaceBuilder<SurfaceBuilderConfig> NIDAVELLIR = register("nidavellir", new NidavellirSurfaceBuilder(SurfaceBuilderConfig.field_237203_a_));
