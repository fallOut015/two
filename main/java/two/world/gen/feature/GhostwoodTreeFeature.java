...
public class GhostwoodTreeFeature extends AbstractTreeFeature<TreeFeatureConfig> {
	public GhostwoodTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> deserializer) {
		super(deserializer);
	}
