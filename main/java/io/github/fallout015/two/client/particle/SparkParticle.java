...
public class SparkParticle extends SpriteTexturedParticle {
	private SparkParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, IAnimatedSprite spriteSet) {
		...
		this.motionX = this.motionX * (double)0.01F + xSpeedIn + (this.rand.nextFloat() * 2f - 1f) * 0.05f;
		this.motionY = this.motionY * (double)0.01F + ySpeedIn + (this.rand.nextFloat() * 2f - 1f) * 0.05f;
		this.motionZ = this.motionZ * (double)0.01F + zSpeedIn + (this.rand.nextFloat() * 2f - 1f) * 0.05f;
