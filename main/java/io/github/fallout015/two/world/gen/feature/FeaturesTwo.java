...
// Also has configs, placements, and states (and ruletests). 

public class FeaturesTwo { // Configured features with placements. 
	// Trees
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> MAPLE = register("maple", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FeaturesTwo.States.MAPLE_LOG), new SimpleBlockStateProvider(FeaturesTwo.States.MAPLE_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CHERRY = register("cherry", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FeaturesTwo.States.CHERRY_LOG), new SimpleBlockStateProvider(FeaturesTwo.States.CHERRY_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> GHOSTWOOD = register("ghostwood", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FeaturesTwo.States.GHOSTWOOD_LOG), new SimpleBlockStateProvider(FeaturesTwo.States.GHOSTWOOD_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CLOUDWOOD = register("cloudwood", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FeaturesTwo.States.CLOUDWOOD_LOG), new SimpleBlockStateProvider(FeaturesTwo.States.CLOUDWOOD_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BLACKBARK = register("blackbark", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FeaturesTwo.States.BLACKBARK_LOG), new SimpleBlockStateProvider(FeaturesTwo.States.BLACKBARK_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
	public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> FROSTBARK = register("frostbark", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(FeaturesTwo.States.FROSTBARK_LOG), new SimpleBlockStateProvider(FeaturesTwo.States.FROSTBARK_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
	// Ores
	public static final ConfiguredFeature<?, ?> ORE_DESERT_COAL = register("ore_desert_coal", Feature.ORE.withConfiguration(new OreFeatureConfig(FeaturesTwo.RuleTests.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_COAL_ORE, 19/*size*/)).func_242733_d(128/*y max*/).func_242728_a().func_242731_b(20 /*spread*/));
	public static final ConfiguredFeature<?, ?> ORE_DESERT_IRON = register("ore_desert_iron", Feature.ORE.withConfiguration(new OreFeatureConfig(FeaturesTwo.RuleTests.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_IRON_ORE, 11)).func_242733_d(64).func_242728_a().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> ORE_DESERT_GOLD = register("ore_desert_gold", Feature.ORE.withConfiguration(new OreFeatureConfig(FeaturesTwo.RuleTests.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_GOLD_ORE, 11)).func_242733_d(48).func_242728_a().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> ORE_DESERT_COPPER = register("ore_desert_copper", Feature.ORE.withConfiguration(new OreFeatureConfig(FeaturesTwo.RuleTests.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_COPPER_ORE, 11)).func_242733_d(48).func_242728_a().func_242731_b(20));
	...
	public static final ConfiguredFeature<?, ?> ORE_OPAL = register("ore_opal", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, FeaturesTwo.States.OPAL_ORE, 7)).func_242733_d(8).func_242728_a().func_242731_b(10));
	public static final ConfiguredFeature<?, ?> ORE_TANZANITE = register("ore_tanzanite", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, FeaturesTwo.States.TANZANITE_ORE, 1)).func_242733_d(16).func_242728_a());
	public static final ConfiguredFeature<?, ?> ORE_RUBY = register("ore_ruby", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, FeaturesTwo.States.RUBY_ORE, 8)).func_242733_d(16).func_242728_a());
	public static final ConfiguredFeature<?, ?> ORE_TALC = register("ore_talc", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.field_241882_a, FeaturesTwo.States.TALC_ORE, 17)).func_242733_d(128).func_242728_a().func_242731_b(40));
	...
	// Mushrooms
	public static final ConfiguredFeature<?, ?> HUGE_NEONDOT = register("huge_neondot", FeatureTwo.HUGE_NEONDOT.get().withConfiguration(new BigMushroomFeatureConfig(new SimpleBlockStateProvider(FeaturesTwo.States.NEONDOT_CAP), new SimpleBlockStateProvider(FeaturesTwo.States.NEONDOT_STEM), 2)));
	public static final ConfiguredFeature<?, ?> HUGE_BRIMSHINE = register("huge_brimshine", FeatureTwo.HUGE_BRIMSHINE.get().withConfiguration(new BigMushroomFeatureConfig(new SimpleBlockStateProvider(FeaturesTwo.States.BRIMSHINE_CAP), new SimpleBlockStateProvider(FeaturesTwo.States.BRIMSHINE_STEM), 3)));
	// Stone Replacers
	public static final ConfiguredFeature<?, ?> DESERT_STONE_REPLACER = register("desert_stone_replacer", FeatureTwo.MULTI_REPLACE_BLOCK.get().withConfiguration(new MultiReplaceBlockConfig(States.STONE, States.SMOOTH_SANDSTONE, States.STONE, States.SAND)).withPlacement(PlacementTwo.PLACE_ALL_TO_64.get().configure(IPlacementConfig.NO_PLACEMENT_CONFIG)));
	public static final ConfiguredFeature<?, ?> ICY_STONE_REPLACER = register("icy_stone_replacer", FeatureTwo.REPLACE_BLOCK.get().withConfiguration(new ReplaceBlockConfig(States.STONE, Blocks.PACKED_ICE.getDefaultState())).withPlacement(PlacementTwo.PLACE_ALL_TO_64.get().configure(IPlacementConfig.NO_PLACEMENT_CONFIG)));
	public static final ConfiguredFeature<?, ?> MUSHROOM_STONE_REPLACER = register("mushroom_stone_replacer", FeatureTwo.MULTI_REPLACE_BLOCK.get().withConfiguration(new MultiReplaceBlockConfig(States.STONE, States.SPORESTONE, States.STONE, States.SPORESTONE_SOIL)).withPlacement(PlacementTwo.PLACE_ALL_TO_64.get().configure(IPlacementConfig.NO_PLACEMENT_CONFIG)));
