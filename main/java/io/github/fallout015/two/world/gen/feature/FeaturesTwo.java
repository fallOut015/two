...
import io.github.fallout015.two.world.biome.FrequencyConfig;
...
public class FeaturesTwo { // Configured features with placements. 
	...
	// Ores
	public static final ConfiguredFeature<?, ?> ORE_DESERT_COAL = register("ore_desert_coal", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_COAL_ORE, 20/*size*/)).func_242733_d(128/*y max*/).func_242728_a().func_242731_b(20 /*spread*/));
	public static final ConfiguredFeature<?, ?> ORE_DESERT_IRON = register("ore_desert_iron", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_IRON_ORE, 18)).func_242733_d(64).func_242728_a().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> ORE_DESERT_GOLD = register("ore_desert_gold", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_GOLD_ORE, 18)).func_242733_d(48).func_242728_a().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> ORE_DESERT_COPPER = register("ore_desert_copper", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.SMOOTH_SANDSTONE, FeaturesTwo.States.DESERT_COPPER_ORE, 18)).func_242733_d(48).func_242728_a().func_242731_b(20));

	public static final ConfiguredFeature<?, ?> ORE_END_COBALT = register("ore_end_cobalt", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.END_STONE, FeaturesTwo.States.END_COBALT_ORE, 7)).func_242733_d(128).func_242728_a().func_242731_b(20));
	public static final ConfiguredFeature<?, ?> ORE_END_JADE = register("ore_end_jade", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.END_STONE, FeaturesTwo.States.END_JADE_ORE, 7)).func_242733_d(128).func_242728_a().func_242731_b(20));
	...
	public static final ConfiguredFeature<?, ?> ORE_END_SAPPHIRE = register("ore_end_sapphire", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.END_STONE, FeaturesTwo.States.END_SAPPHIRE_ORE, 7)).func_242733_d(128).func_242728_a().func_242731_b(20));
	...
	public static final ConfiguredFeature<?, ?> ORE_END_PLATINUM = register("ore_end_platinum", Feature.ORE.withConfiguration(new OreFeatureConfig(FeatureTwo.END_STONE, FeaturesTwo.States.END_PLATINUM_ORE, 5)).func_242733_d(128).func_242728_a().func_242731_b(20));
	...
	public static final ConfiguredFeature<?, ?> NUDE_BRIMSHINE = register("huge_brimshine", FeatureTwo.HUGE_BRIMSHINE.withConfiguration(new BigMushroomFeatureConfig(new SimpleBlockStateProvider(FeaturesTwo.States.BRIMSHINE_CAP), new SimpleBlockStateProvider(FeaturesTwo.States.BRIMSHINE_STEM), 3)));
	// Stone Replacers
