...
import io.github.fallout015.two.client.renderer.entity.model.BoatModelTwo;
...
@OnlyIn(Dist.CLIENT)
public class BoatRendererTwo extends EntityRenderer<BoatEntityTwo> {
	private static final ResourceLocation[] BOAT_TWO_TEXTURES = new ResourceLocation[]{new ResourceLocation("two", "textures/entity/boat/crimson.png"), new ResourceLocation("two", "textures/entity/boat/warped.png")};
	protected final BoatModelTwo modelBoat = new BoatModelTwo();

	public BoatRendererTwo(EntityRendererManager renderManagerIn) {
		super(renderManagerIn);
		this.shadowSize = 0.8F;
	}

	public void render(BoatEntityTwo entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
		matrixStackIn.push();
	...
	public ResourceLocation getEntityTexture(BoatEntityTwo entity) {
		return BOAT_TWO_TEXTURES[entity.getBoatType().ordinal()];
	}
}