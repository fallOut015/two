...
public class FrostbiteSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
	public FrostbiteSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> deserializer) {
		super(deserializer);
	}
